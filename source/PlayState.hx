...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
			case 'striker':
				strikerbackground = new FlxSprite(0, -1700, Paths.image("strikeback/cheater", "shared"));
	...
	override public function update(elapsed:Float)
	{
		...
		switch (curStage)
		{
			...
			case 'striker' | 'bruhsoundeffect':
				...
				//	trace(cube.x);
					if (cube.x >= cubeend) // fortnite reference
					{
						cube.loadGraphic(Paths.image("strikeback/cube" + FlxG.random.int(1, 6), "shared"));
	...
	public function spawnNoteSplashOnNote(note:Note) {
		if(ClientPrefs.noteSplashes && note != null && SONG.song.toLowerCase() != "strikeback") {
	...
	override function beatHit()
	{
		...
		if (SONG.song.toLowerCase() == 'strikeback')
		{
			...
			{
				case 112:
					strikerbackground.loadGraphic(Paths.image("strikeback/redsky"));
					strikerbackground.x = 0;
				case 240:
					strikerbackground.loadGraphic(Paths.image("strikeback/cheater GLITCH"));
					strikerbackground.x = 0;
					cubestart = 500;
					backgroundspeed = 10;
					cubespeed = 450;
					...
					cubeend = 8000;
				case 272:
					strikerbackground.loadGraphic(Paths.image("strikeback/scarybg"));
					strikerbackground.x = 0;
					cubestart = 15200;
					backgroundspeed = 2;
					cubespeed = 200;
				...
				case 368:
					...
					strikerbackground.x = 0;
				case 400:
					strikerbackground.loadGraphic(Paths.image("strikeback/spike"));
					strikerbackground.x = 0;
				case 412:
					boyfriend.singDuration = 224;
				case 414:
					isCameraOnForcedPos = true;
				case 416:
					defaultCamZoom = 1.2;
				...
				case 427:
					...
					cameraSpeed = 1;
				case 432:
					strikerbackground.loadGraphic(Paths.image("strikeback/interdimensionVoid"));
					strikerbackground.x = 0;
					boyfriend.singDuration = 4;
				case 472:
					strikerbackground.loadGraphic(Paths.image("strikeback/cheater"));
					strikerbackground.x = 0;
				case 536:
					strikerbackground.loadGraphic(Paths.image("strikeback/glitchy_cheating_2"));
					strikerbackground.x = 0;
					cubestart = 500;
					backgroundspeed = 8;
					cubespeed = 450;
